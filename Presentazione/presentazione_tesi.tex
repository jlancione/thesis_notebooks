...
\begin{frame}{Risultati - Dataset \only<1>{$Z$}\only<2->{$W$}}
  \vspace*{2.5ex}%
  \only<1-2>{architettura: \parbox{12ex}{(64,64)} algoritmo: Adam\qquad attivazione: sigmoide}%
  \only<3>{architettura: \parbox{12ex}{(3,3)} algoritmo: Adam\qquad attivazione: relu}%
  ...
  \parbox[c][.4\textwidth]{\textwidth}{
    \begin{columns}
      \column{.45\linewidth}
        ...
        \only<3>{\includegraphics[width=\linewidth]{./Images/W3_3_Adam_relu_acc.pdf}}
      ...
      \column{.45\linewidth}
        ...
        \only<3>{\includegraphics[width=\linewidth]{./Images/W3_3_Adam_relu_rock.pdf}}
