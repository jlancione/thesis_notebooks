...
\begin{frame}{Risultati}
  \vspace*{2.5ex}%
  \only<1>{Z: (64,64), algoritmo: Adam, attivazione: sigmoide}%
  \only<2>{W: (3,3), algoritmo: Adam, attivazione: relu}%
  \only<3>{W: (24,12,24), algoritmo: Adam, attivazione: sigmoide}%
  \vspace*{3.5ex}
  \parbox[c][.4\textwidth]{\textwidth}{
    \begin{columns}
      \column{.45\linewidth}
        ...
        \only<2>{\includegraphics[width=\linewidth]{./Images/W3_3_Adam_relu_acc.pdf}}
        \only<3>{\includegraphics[width=\linewidth]{./Images/W24_12_24_Adam_sigmoid_acc.pdf}}
      \column{.45\linewidth}
        \centering
        \only<1>{\includegraphics[width=\linewidth]{./Images/Z64_64_adam_sigmoid_rock.pdf}}
        \only<2>{\includegraphics[width=\linewidth]{./Images/W3_3_Adam_relu_rock.pdf}}
        \only<3>{\includegraphics[width=\linewidth]{./Images/W24_12_24_adam_sigmoid_rock.pdf}}
    \end{columns}%
  }
  \begin{center}
