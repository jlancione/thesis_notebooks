...
%   \end{tikzpicture}
  \begin{columns}
    \column{.25\linewidth}
      \begin{figure}
        \centering
        \includegraphics[width=.4\textwidth]{./cern_logo.pdf}\\
        \vspace{1ex}
        \includegraphics[width=.4\textwidth]{./cms_logo.pdf}
      \end{figure}
    \column{.70\linewidth}
      \begin{figure}
        \includepdf[width=\textwidth]{./cms_cutaway.pdf}
      \end{figure}
      \begin{flushright}
        \vspace{-2ex}
        \scalebox{.4}{
...
\begin{frame}{ML: uno sguardo d'insieme}
  \vspace*{-3ex}
  \begin{figure}
    \centering
    \resizebox{\linewidth}{!}{
...
% }
  ...
  \begin{columns}[T]
    \column{.40\linewidth}
      ...
      \begin{figure}
        \centering
        \includepdf[width=\textwidth]{./sm_overview.pdf}
      \end{figure}
      \begin{flushleft}
        \vspace{-3ex}
        \scalebox{.4}{
...
\begin{frame}{L'architettura}
  \vspace*{4.5ex}
  \begin{figure}
    \includepdf[width=\linewidth]{./fcn-architecture-simple.pdf}
  \end{figure}
  \begin{flushright}
    \vspace*{2.0ex}
    \scalebox{.4}{
